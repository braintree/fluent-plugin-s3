      ...
      if @check_object
        begin
          ...
          if @localtime
            ...
            ymdhms_slicer = Time.now.strftime("%Y%m%d%H%M%S")
            hive_ymd_slicer = Time.now.strftime("year=%Y/month=%m/day=%d")
          else
            hms_slicer = Time.now.utc.strftime("%H%M%S")
            ymdhms_slicer = Time.now.utc.strftime("%Y%m%d%H%M%S")
            hive_ymd_slicer = Time.now.utc.strftime("year=%Y/month=%m/day=%d")
          end
          ...
          values_for_s3_object_key = {
            ...
            "ymdhms_slice" => ymdhms_slicer,
            "hive_ymd_slice" => hive_ymd_slicer,
            "index" => i,
